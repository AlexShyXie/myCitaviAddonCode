...
namespace SearchInActiveGroupAddon
{
        ...
        CitaviAddOn<MainForm>
    {
        public override void OnHostingFormLoaded(MainForm mainForm)
        {
            ...
            // 这里是放在开关侧边栏的那里
            mainForm.GetReferenceEditorFilterCommandbarManager().GetCommandbar(MainFormReferenceEditorFilterCommandbarId.Toolbar).AddCommandbarButton("SearchInActiveCategory", "Search active category in advanced search", CommandbarItemStyle.ImageOnly, SwissAcademic.Citavi.Shell.Properties.Resources.SearchTask);
